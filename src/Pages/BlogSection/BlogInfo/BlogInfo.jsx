...
const BlogInfo = () => {
  return (
    <div className='bg-white py-2 px-2 shadow-md relative'>
        ...
        <h3 className='mt-4 text-[18px] cursor-pointer'><span className='hover:text-[#cf802e]'>ADMIN / </span>  <span className='hover:text-[#cf802e]'> ACCESSORIES / </span> <span className='hover:text-[#cf802e]'>CASUAL /</span>
        <span> 3 COMMENTS</span></h3>

        <h1 className='lg:text-4xl md:text-3xl text-2xl font-bold mt-2 mb-2 hover:text-[#cf802e]'>Sweet, sweet burn of sun and summer wind.</h1>
