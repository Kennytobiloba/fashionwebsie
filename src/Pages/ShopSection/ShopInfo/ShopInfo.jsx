         ...
         <div className='flex md:flex-row flex-col md:mx-0 mx-auto mt-20 2xl:gap-10 gap-10 lg:gap-2 w-[100%] ' >
            <div className='flex-shrink-0 mx-auto md:mx-0  h-[70vh] md:w-[50%] lg:w-[60%] w-[100%]   ' >
                ...
                >
                    <SwiperSlide>
                        <div>
                            <img src={assets.Product_one} alt="" className='w-full h-full object-cover' />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={assets.Product_two} alt="" className='w-full h-full object-cover' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={assets.Product_three} alt="" className='w-full h-full object-cover' />
                    </SwiperSlide>
                </Swiper>
            ...
            <div className=' text-center md:text-start md:w-[50%] w-full '>
                ...
                <h3 className='lg:text-2xl text-[18px] mb-4'>$3456</h3>
                ...
                <div className='flex gap-4 items-center mt-6  justify-center md:justify-start'>
                    ...
                    <h6 onClick={()=>{addToCart(id)}}><a className="button capitalize 2xl:text-[16px] text-[14px] font-bold hover:bg-gray-500 md:p-4  inline-block  text-white bg-[#cf802e] py-4 px-6 md:px-2 " href="#">Add to cart</a></h6>
                </div>
