  ...
  return (
    <div>
      ...
      <div className='  text-center'>
        ...
        <h1 className='lg:text-3xl md:text-2xl text-lg  mt-2 font-bold mb-2 '>Shopping Every Day</h1>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2  md:grid-cols-2 2xl:grid-cols-4 sm:grid-cols-2 mt-6 gap-10'>
        {
