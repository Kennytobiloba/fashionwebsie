...
const SummerCollection = () => {
  return (
    <div className='mx-auto lg:w-[80%] gap-10 w-full mt-20  md:grid-cols-2 grid grid-cols-1'>
        <div>
        ...
        <div className=' flex justify-center flex-col px-6 md:px-0'>
            ...
            <h6 className="mt-8 "><a className=" md:inline-block inline-block  hover:bg-gray-500 px-12 mt-4 text-[16px] py-4  text-white bg-[#cf802e]" href="#">See Whole Collection</a></h6>
        </div>
    </div>
  )
}
