...
const OtherCollection = () => {
  return (
    <div className='mx-auto lg:w-[80%] w-[90%] mt-20'>
        <div className='text-center'>
            <h3 className='md:text-[18px] text-[16px] lg:text-[20px] text-[#cf802e] mb-2'>OTHER COLLECTION</h3>
            <h1 className='lg:text-3xl md:text-2xl text-[26px] font-bold  mb-4'>Trending Products</h1>
        </div>
