    ...
    return (
        <div className='flex md:flex-row flex-col md:mx-0 mx-auto mt-20 gap-10 w-[100%] ' >
            ...
            <div className=' text-center md:text-start md:w-[50%] w-full '>
                ...
                <h6 className="mt-6 text-[18px] font-bold"><a href="#"><i className="fa fa-heart text-[#cf802e]"></i> Add to Wishlist</a></h6>
                <h6 className="mt-4 text-[18px] capitalize"><span className="font-bold">SKU</span> / 1-2</h6>
                <h6 className="mt-4 text-[18px] capitalize"><span className="font-bold">CATEGORY</span> / Store</h6>
                <h6 className="mt-4 text-[18px] mb-0 capitalize"><span className="font-bold">TAGS</span> / Shopping, Clothes</h6>
            </div>
        </div>
    );
}
